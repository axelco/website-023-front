  ...
  <div class="job-item">
    ...
    <div v-else>
      ...
      <p class="job-metas mb-2">
        <span class="text-uppercase">{{ props.job.contractType }}</span> -
        {{ datesSentence }} ({{ nbYearsInJob }})
      </p>
      <p v-if="hasShortDescription" class="job-description">
      ...
      <RouterLink
        ...
        >Voir des détails sur mon job {{ props.job.name }}
